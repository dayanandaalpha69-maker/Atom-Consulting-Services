...
.about{background:#071A2F;border-radius:28px;padding:54px;color:white;margin:70px 0}.about h2{color:white;font-size:clamp(1.9rem,4vw,3.25rem);font-style:italic;font-weight:600;line-height:1.08;max-width:680px}.about .lead{color:#B9CBDD}.about-point{border-top:1px solid rgba(255,255,255,.13);padding:16px 0}.about-point strong{color:white;display:block;margin-bottom:5px}.about-point span{color:#AFC2D5;font-size:.9rem}
